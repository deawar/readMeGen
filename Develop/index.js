...
async function writeToFile (data, outputPath) {
  ...
  const projectTitle = data.projectTitle // Todo parse string to remove spaces and replace with %20
  ...
  const urprojectUrl = data.projectUrl
  const questionsTOC = '* [Questions](#questions) \n'
  const questions = '## Questions \n'
  const questionsLink = '![' + gitName + '](' + avatar_url + '&s=48)  Email: [' + gitName + '](mailto:' + gitEmail + ') or  click on [@' + gitName + '](' + gituserUrl + ')'
